...
const initialState=async()=>{
    let initialState={
        ...
        regions: await selectallregions().catch(error => console.error(`Regions: ${error}`)),
        regiondistricts:await selectallregsdistricts().catch(error => console.error(`Districts of regions: ${error}`)),
        locations:await selectalllocations().catch(error => console.error(`Locations: ${error}`)),
        towndistricts:await selectalltowndistricts().catch(error => console.error(`Towns districts: ${error}`)),
        streets:await selectallstreets().catch(error => console.error(`Streets: ${error}`)),
